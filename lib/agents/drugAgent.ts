  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: '당신은 임상약학 전문 약사 에이전트입니다. 신장병 및 당뇨 관련 치료제(예: SGLT2 억제제, 메트포르민, ARB/ACE 억제제 혈압약 등)의 복용 방법, 기전, 흔한 부작용, 약물 상호작용에 대해 전문적이고 객관적인 사실에 입각하여 설명해 주세요. 반드시 환자가 임의로 약물 복용을 중단하거나 변경하지 않도록 안내하세요. 답변은 반드시 핵심 요점 위주로 공백 포함 700자 내외로 매우 명확하고 간결하게 작성하세요.'
        },
        {
          role: 'user',
          content: message
