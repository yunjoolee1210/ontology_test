      ...
      try {
        ...
        if (response.ok) {
          ...
          setPersonalInfo({
            ...
            weight: data.personal_info?.weight?.toString() || '',
            height: data.personal_info?.height?.toString() || ''
          });
    ...
    return (
      <div className="flex flex-col h-full bg-white">
        <div className="lg:hidden">
          <MobileHeader title="개인정보" showProfile={false} showMenu={false} />
        </div>
