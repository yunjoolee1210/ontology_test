...
import { Send, Image as ImageIcon, Stethoscope, Utensils, FileText, ChevronDown, ChevronUp, ThumbsUp, ThumbsDown, Copy, RotateCcw } from 'lucide-react';
...
export function ChatPage() {
  ...
  const handleSendMessage = async (text?: string) => {
    ...
    if (isFirstMessage && isMeaninglessFirstMessage(messageText)) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] bg-white relative">
      ...
      {/* Input Area - ChatGPT style, same width as content */}
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent pt-4 pb-6 z-20">
