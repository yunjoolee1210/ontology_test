...
// 이미지는 Unsplash CDN에서 고품질 식재료 사진 사용
// 동일한 스타일/배경으로 통일된 이미지 제공
export const LOW_POTASSIUM_VEGETABLES: IngredientCard[] = [
  { id: 'cabbage', name: '양배추', thumbnail: 'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=200&h=160&fit=crop&crop=center', potassium: 170, category: 'vegetable', description: '쌈, 샐러드, 볶음 등 다양하게 활용' },
  { id: 'cucumber', name: '오이', thumbnail: 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=200&h=160&fit=crop&crop=center', potassium: 147, category: 'vegetable', description: '냉국, 무침, 샐러드에 좋음' },
  { id: 'eggplant', name: '가지', thumbnail: 'https://images.unsplash.com/photo-1628773822503-930a7eaecf80?w=200&h=160&fit=crop&crop=center', potassium: 230, category: 'vegetable', description: '볶음, 찜, 구이로 활용' },
  { id: 'lettuce', name: '상추', thumbnail: 'https://images.unsplash.com/photo-1556801712-76c8eb07bbc9?w=200&h=160&fit=crop&crop=center', potassium: 194, category: 'vegetable', description: '쌈 채소로 최적' },
  { id: 'bellpepper', name: '피망', thumbnail: 'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=200&h=160&fit=crop&crop=center', potassium: 175, category: 'vegetable', description: '볶음, 샐러드에 활용' },
  { id: 'iceberg', name: '양상추', thumbnail: 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?w=200&h=160&fit=crop&crop=center', potassium: 141, category: 'vegetable', description: '샐러드, 샌드위치에 좋음' },
  { id: 'zucchini', name: '애호박', thumbnail: 'https://images.unsplash.com/photo-1563252722-6434563a985d?w=200&h=160&fit=crop&crop=center', potassium: 261, category: 'vegetable', description: '전, 볶음, 찌개에 활용' },
  { id: 'radish', name: '무', thumbnail: 'https://images.unsplash.com/photo-1522184216316-3c25379f9760?w=200&h=160&fit=crop&crop=center', potassium: 227, category: 'vegetable', description: '국, 나물, 깍두기로 활용' },
  { id: 'beansprout', name: '콩나물', thumbnail: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=200&h=160&fit=crop&crop=center', potassium: 169, category: 'vegetable', description: '무침, 국에 좋음' },
  { id: 'onion', name: '양파', thumbnail: 'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cb?w=200&h=160&fit=crop&crop=center', potassium: 146, category: 'vegetable', description: '볶음, 조림에 기본 재료' },
];
